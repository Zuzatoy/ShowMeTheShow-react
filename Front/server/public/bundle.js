...
var MainInt = function (_React$Component) {
  _inherits(MainInt, _React$Component);

  function MainInt(props) {
    _classCallCheck(this, MainInt);

    var _this = _possibleConstructorReturn(this, (MainInt.__proto__ || Object.getPrototypeOf(MainInt)).call(this, props));
  ...
  _createClass(MainInt, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      var _this2 = this;

      // addUser(null)
      (0, _apiClient.getAllUsers)().then(function (users) {
...
var _MainInt = __webpack_require__(34);

var _MainInt2 = _interopRequireDefault(_MainInt);
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        null,
        _react2.default.createElement(_reactRouterDom.Route, { path: '/mainint', component: _MainInt2.default })
      )
    )
  );
};
...
var rootUrl = 'http://localhost:4000/api';

function getAllUsers() {
  return _superagent2.default.get(rootUrl + '/getAllUsers').then(function (res) {
    return res.body.users;
  });
}

function getUser(id) {
  var reqStr = 'getUser' + id;
  return _superagent2.default.get(rootUrl + reqStr).then(function (res) {
    return res.body.user;
  });
}

function addUser(userData) {
  _superagent2.default.post(rootUrl + '/addUser').set('Content-Type', 'application/json').send(userData).end();
}
...
var _MainButton = __webpack_require__(91);
    ...
    _createClass(Main, [{
        ...
        value: function display(location) {
            switch (location) {
                ...
                case 'main':
                    return _react2.default.createElement(_MainInt2.default, { goTo: this.goTo });
            }
        }
    }, {
        key: 'render',
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                "button",
                {
                    ...
                    } // onClick call an anonymus function which calls goTo function 
